...
import client.view.user.ClientHistoryMenuRowController;
...
public class ClientHistoryMenu extends Application implements Menuable {
	...
	private HBox rowCreator(String gameDetails) {
		...
		ClientHistoryMenuRowController controller = loader.getController();
